...
public class FourInRowGame {
    ...
    private FourInRowColumn[] columns;
    private boolean whitePlayedFirst;
     ...
     */
    public FourInRowGame(int numCols, int numRows)
    {
        columns=new FourInRowColumn[numCols];
        for(int i = 0; i < numCols; i++)
        {
            columns[i] = new FourInRowColumn(numRows);
        }
    }
    /**
     ...
     */
    public FourInRowGame(FourInRowGame game)
    {
        columns = new FourInRowColumn[game.getColumnCount()];
        for (int i = 0; i < game.getColumnCount(); i++)
        {
            columns[i] = new FourInRowColumn(game.getColumn(i));
        }
    }
     ...
     */
    public FourInRowColumn getColumn(int i)
    {
     ...
     */
    public String validate(FourInRowGame after)
    {
     ...
     */
    public boolean getWhitePlayedFirst()
    {
        return whitePlayedFirst;
    }
     ...
     */
    public void setWhitePlayedFirst(boolean whitePlayedFirst)
    {
        this.whitePlayedFirst = whitePlayedFirst;
    }
}
