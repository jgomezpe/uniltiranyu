...
//  MultiChart multiChart1 = new MultiChart();
  ...
  public MultiAgentLabyrinthMainFrame( Array<Agent> _agent, SimpleLanguage _language ) {
    this( "Labyrinth", _agent, _language );
  }

  public MultiAgentLabyrinthMainFrame( String _title, Array<Agent> _agent, SimpleLanguage _language ) {
    title = _title;
